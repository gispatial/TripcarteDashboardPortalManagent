...
const router = new Router({
    ...
    // =============================================================================
        ...
        // =============================================================================
                {
                    path: '/',
                    redirect: '/ui-elements/card/statistics'
                },
                {
                ...
                },
                {
                    ...
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Attractions'},
                            { title: 'Listings', url: {name: 'ecommerce-shop'} },
        ...
        // =============================================================================
                {
                    ...
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Attractions'},
                            { title: 'Products View', active: true },
                        ],
                        pageTitle: 'Product Listing and Changes',
                        rule: 'editor'
                    },
                },
                {
                    ...
                    meta: {
                        breadcrumb: [
                            ...
                            { title: 'Listings View', active: true },
                        ],
                        pageTitle: 'Attractions Listings View',
                        rule: 'editor'
                    },
                },
                {
                ...
                },
                {
                    ...
                    meta: {
                        ...
                        pageTitle: 'Attractions and Merchants Dashboard',
                        rule: 'admin'
                    },
                },
                {
                ...
                },
                {
                    ...
                    meta: {
                        ...
                        pageTitle: 'View all redeemed tickets',
                        rule: 'editor'
                    },
                },
