...
<template>
  ...
  <div class="vx-row">
    ...
    <vx-card slot="no-body" class="text-center bg-primary-gradient greet-user">
      ...
      <h1 class="mb-6 text-white">Welcome {{ checkpointReward.userName }}, to our official management portal </h1>
...
&nbsp;
          ...
          <div class="vx-row">
            ...
            <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
              <statistics-card-line icon="ShoppingBagIcon" statistic="RM 2300" statisticTitle="Total Pending Payout" :chartData="subscribersGained.series" type='area'></statistics-card-line>
            </div>

            <!-- CARD 3: ORDER RECIEVED -->
            <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
              <statistics-card-line icon="UsersIcon" statistic="350 tickets . + 15%" statisticTitle="Total Redemption this Week" :chartData="ordersRecevied.series" color='warning' type='area'></statistics-card-line>
            </div>
          </div>
          ...
          <div class="vx-row">
            ...
            <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
                <vx-card title="Total Redemption this Week">
                    <!-- CARD ACTION -->
              ...
              <div class="vx-row">
                  ...
                  <div class="vx-col w-full lg:w-1/3 mb-base">
                      <vx-card title="Attractions Booking">
                          <!-- CARD ACTION -->
                          <template slot="actions">
                              <change-time-duration-dropdown />
                          </template>
                  ...
                  <!-- CARD 7: Sales Stats -->
                  <div class="vx-col w-full lg:w-1/3 mb-base">
                    <vx-card title="Total Redemption this Year" subtitle="Last 6 Months">
                      <template slot="actions">
