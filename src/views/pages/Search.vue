<!-- =========================================================================================
    ...
    Publisher URL: https://tripcarte.asia
========================================================================================== -->
...
<template>
    <div id="search-page">
        <div class="search-page__search-bar flex items-center">
            <vs-input icon-no-border placeholder="Reviews" v-model="searchQuery" class="w-full input-rounded-full" icon="icon-search" icon-pack="feather" />
        </div>
        <div class="search-page__serch-menu flex flex-wrap items-center md:justify-between mt-8">
            <div class="flex flex-wrap">
                ...
                <span class="search-tab-filter shadow-drop">Top Destinations</span>
                <span class="search-tab-filter shadow-drop">Special Promotion</span>
                <span class="search-tab-filter shadow-drop">Most Popular</span>
                <span class="search-tab-filter shadow-drop">New Attractions</span>
                <vs-dropdown vs-trigger-click class="search-tab-filter shadow-drop">
                    <span>More</span>
                    <vs-dropdown-menu class="search-page__more-dropdown">
                        <vs-dropdown-item>Attractions</vs-dropdown-item>
                        <vs-dropdown-item>Reviews</vs-dropdown-item>
                        <vs-dropdown-item>Travel Agent</vs-dropdown-item>
                        <vs-dropdown-item>Finance</vs-dropdown-item>
                        <vs-dropdown-item>Merchant</vs-dropdown-item>
                    </vs-dropdown-menu>
                </vs-dropdown>
            </div>
            <div>
                ...
                <span class="search-tab-filter mr-0 shadow-drop">Commissions</span>
            </div>
        </div>
...
export default{
    data() {
        return {
            searchQuery: 'Search Reviews',
            currentPage: 1,
            knowledgePanel: {
                img         : require("@/assets/images/pages/modern.jpg"),
                title       : 'Get RM50 OFF when spend more than RM800',
                ...
                externalLink: {
                    title: 'View on Tripcarte Affliate Area',
                    icon: 'ExternalLinkIcon',
                    url: 'https://tripcarte.asia/affiliate-area/',
                },
                resultMetaList: [
