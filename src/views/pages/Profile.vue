    ...
    <div id="profile-page">
                ...
                <div :class="isNavOpen ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
                    <div class="text-sm sm:flex-grow">
                        <ul class="sm:flex justify-around mt-8 w-full md:mt-0 md:ml-auto md:w-3/4">
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Redemption Reports</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Notification</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Reviews</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Bookings</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Redemption</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">Support</router-link></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full lg:w-1/4">
                ...
                <!-- LATEST PHOTOS -->
                <vx-card title="Latest Attractions" class="mt-base">
...
export default {
  data() {
    return {
      ...
      suggestedFriends: [
        { name: 'Nurfaseha', avatar: require("@/assets/images/portrait/small/logo.png"),  mutualFriends: 6 },
        { name: 'Finance', avatar: require("@/assets/images/portrait/small/logo.png"),  mutualFriends: 3 },
        { name: 'Tripcarte Customer Experience', avatar: require("@/assets/images/portrait/small/logo.png"),  mutualFriends: 2 },
        { name: 'Ed',  avatar: require("@/assets/images/portrait/small/logo.png"),  mutualFriends: 1 },
        { name: 'Brian', avatar: require("@/assets/images/portrait/small/logo.png"),  mutualFriends: 1 },
        { name: 'Arazz',     avatar: require("@/assets/images/portrait/small/logo.png"), mutualFriends: 1 },
        { name: 'Parthiven Shan',      avatar: require("@/assets/images/portrait/small/avatar-s-3.jpg"), mutualFriends: 1 },
        { name: 'Vaani', avatar: require("@/assets/images/portrait/small/logo.png"), mutualFriends: 1 },
      ],
      userLatestPhotos: [
        require("@/assets/images/profile/user-uploads/logo.png"),
        require("@/assets/images/profile/user-uploads/logo.png"),
        require("@/assets/images/profile/user-uploads/logo.png"),
        require("@/assets/images/profile/user-uploads/logo.png"),
        require("@/assets/images/profile/user-uploads/logo.png"),
      ...
      userPosts: [{
          ...
          comments   : 77,
          usersLiked : [
            { name: 'Agusti Gunawan',       img: require("@/assets/images/portrait/small/avatar-s-1.jpg") },
            { name: 'ISHTIAQ AHMAD',      img: require("@/assets/images/portrait/small/avatar-s-2.jpg") },
            { name: 'Shazamawati Zam Hashari', img: require("@/assets/images/portrait/small/avatar-s-3.jpg") },
            { name: 'joyce chai',    img: require("@/assets/images/portrait/small/avatar-s-4.jpg") },
            { name: 'Muzammir Shah',    img: require("@/assets/images/portrait/small/avatar-s-5.jpg") },
          ],
          commentbox : '',
          usersCommented: [
            {
              comment : 'orthoplumbate morningtide naphthaline exarteritis',
              author  : 'Rohaidah binti Md Yunos',
        ...
        },
        {
          ...
          comments   : 105,
          usersLiked : [
            { name: 'David May',   img: require("@/assets/images/portrait/small/avatar-s-6.jpg")  },
            { name: 'Normarina Bashah',     img: require("@/assets/images/portrait/small/avatar-s-7.jpg")  },
            { name: 'Nur Sabrina Mohd Arip',     img: require("@/assets/images/portrait/small/avatar-s-8.jpg")  },
            { name: 'Sayha',   img: require("@/assets/images/portrait/small/avatar-s-10.jpg") },
            { name: 'shahrul', img: require("@/assets/images/portrait/small/avatar-s-9.jpg")  },
          ],
          commentbox: '',
          usersCommented: [
            {
              comment : 'I love cupcake danish jujubes sweet.',
              author  : 'Mohamad Mustaffa Baharudin',
              img     : require("@/assets/images/portrait/small/avatar-s-8.jpg"),
              time    : 'Mon Dec 11 2018 09:56:05 GMT+0000 (GMT)'
            },
            {
              comment : 'Wafer I love brownie jelly bonbon tart apple pie',
              author  : 'Trinh Nhan Toan',
              img     : require("@/assets/images/portrait/small/avatar-s-6.jpg"),
